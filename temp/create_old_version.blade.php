...
@section('content')
    <div class="max-w-4xl mx-auto" x-data="wizardForm">
        {{-- Alerta de Configuraci├│n Bancaria (Usuarios Nuevos / Propietarios) --}}
        ...
        <div x-data="{ showBankingModal: true }" 
            ...
            <!-- El modal ahora es obligatorio form-bloqueante al no tener funci├│n de cierre -->
            <div x-show="showBankingModal"
                 ...
                 <div class="flex flex-col md:flex-row items-stretch">
                     ...
                     <div class="p-8 pb-10 md:w-3/5">
                         <h2 class="text-2xl font-black text-[#003049] mb-4 leading-tight">┬íEst├ís a un paso de recibir pagos! ­ƒÆ©</h2>
                         <p class="text-gray-600 mb-6 leading-relaxed text-sm">
                             Al publicar tu primer inmueble comenzar├ís tu camino como <strong>propietario</strong>.<br><br>
                             <strong>Necesitamos que vincules una cuenta bancaria o CLABE</strong> de forma segura con Stripe para que te lleguen tus pagos. Sin una cuenta configurada, tus inquilinos no podr├ín realizar transferencias autom├íticas desde la App.
                         </p>
        ...
        <div class="mb-8 text-center">
            ...
            <div class="flex items-center justify-center gap-4 relative">
                ...
                <div class="flex flex-col items-center cursor-pointer" @click="if(step > 1) step = 1">
                    ...
                    <span class="text-xs font-medium mt-1 bg-background px-1" :class="step >= 1 ? 'text-primary' : 'text-gray-400'">B├ísico</span>
                </div>
            ...
            <form method="POST" action="{{ route('inmuebles.guardar') }}" class="space-y-6" enctype="multipart/form-data" novalidate>
                ...
                <div x-show="step === 1" x-ref="step1" x-transition:enter="transition opacity-0 transform translate-x-4 ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-4" x-transition:enter-end="opacity-100 translate-x-0">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            ...
                            <input type="text" name="nombre" value="{{ old('nombre') }}" placeholder="Ej. Depa moderno cerca de la UTC" required oninput="this.value = this.value.replace(/[^a-zA-Z0-9\s.,?!;:/\-├í├®├¡├│├║├ü├ë├ì├ô├Ü├▒├æ├╝├£]/g, '')" class="w-full rounded-lg border-input bg-white border py-3 px-4 focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all">
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="md:col-span-2 bg-slate-50 p-5 rounded-xl border border-border mt-2">
                                <label class="block text-sm font-medium mb-3">┬┐El inquilino deber├í dar dep├│sito?</label>
                                <div class="flex gap-4 mb-3">
                                    ...
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        ...
                                        <span class="text-sm font-medium">No, sin dep├│sito</span>
                                    </label>
                                </div>
                                
                                <div x-show="requiereDeposito === 'si'" x-transition class="mt-4 pt-4 border-t border-gray-200">
                                    <label class="block text-sm font-medium mb-3 text-slate-700">Cantidad del dep├│sito</label>
                ...
                <div x-show="step === 2" x-ref="step2" x-transition style="display: none;">
                    <h2 class="text-xl font-bold mb-4 flex items-center gap-2">
                        ...
                        </svg> Caracter├¡sticas y Ubicaci├│n
                    </h2>

                    <div class="mb-4">
                        <label class="block text-sm font-medium mb-1">Direcci├│n Completa <span class="text-red-500">*</span></label>
                        <div class="flex gap-2">
                            <input type="text" name="direccion" id="direccion-input" value="{{ old('direccion') }}" placeholder="Calle, N├║mero, Colonia..." required class="flex-1 rounded-lg border-input bg-white border py-3 px-4">
                            ...
                            <button type="button" onclick="geolocalizar()" title="Usar mi ubicaci├│n actual" class="bg-blue-500 hover:bg-blue-600 text-white p-3 rounded-lg transition-all shadow-md group">
                    ...
                    {{-- Selector de Mapa --}}
                    <div class="mb-6">
                        <label class="block text-sm font-medium mb-2">Marca el punto en el mapa <span class="text-xs text-muted-foreground font-normal">(Seleccionado autom├íticamente al buscar direcci├│n)</span></label>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                        ...
                        <!-- Ba├▒os -->
                        <div>
                            <label class="block text-sm font-medium mb-1">Ba├▒os <span class="text-red-500">*</span></label>
                            <select name="banos_casa" required class="w-full rounded-lg border-input bg-white border py-2 px-3">
                                <option value="0,1" {{ old('banos_casa') === '0,1' ? 'selected' : '' }}>Medio Ba├▒o</option>
                                <option value="1,0" {{ old('banos_casa') === '1,0' ? 'selected' : '' }}>1 Ba├▒o Completo</option>
                                <option value="1,1" {{ old('banos_casa') === '1,1' ? 'selected' : '' }}>1 Ba├▒o Completo y Medio Ba├▒o</option>
                                <option value="2,0" {{ old('banos_casa') === '2,0' ? 'selected' : '' }}>2 Ba├▒os Completos</option>
                                <option value="2,1" {{ old('banos_casa') === '2,1' ? 'selected' : '' }}>2 Ba├▒os Completos y Medio Ba├▒o</option>
                                <option value="3,0" {{ old('banos_casa') === '3,0' ? 'selected' : '' }}>3 Ba├▒os Completos</option>
                                <option value="3,1" {{ old('banos_casa') === '3,1' ? 'selected' : '' }}>3 Ba├▒os Completos y Medio Ba├▒o</option>
                                <option value="4,0" {{ old('banos_casa') === '4,0' ? 'selected' : '' }}>4 Ba├▒os o m├ís</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mb-6 bg-slate-50 p-5 rounded-xl border border-gray-200">
                        ...
                        <div class="grid grid-cols-3 gap-4 items-end">
                            ...
                            <div class="flex items-center justify-center pb-2 text-muted-foreground"><span>├ù</span></div>
                            <div>
                        ...
                        <div class="mt-4 pt-3 border-t border-gray-200">
                            <label class="block text-xs font-bold mb-1 uppercase text-slate-600">├ürea Total (m┬▓) <span class="text-red-500">*</span></label>
                            <div class="relative">
                            ...
                            <p class="text-xs text-slate-700 mt-2 flex items-center gap-1" x-show="largo && ancho">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-3 h-3 text-[#003049]">
                                    <path fill-rule="evenodd" d="M10 2a.75.75 0 01.75.75v1.5a.75.75 0 01-1.5 0v-1.5A.75.75 0 0110 2zM10 15.25a.75.75 0 01.75.75v1.5a.75.75 0 01-1.5 0v-1.5a.75.75 0 01.75-.75zM13.636 5.864a.75.75 0 010 1.06l-1.06 1.06a.75.75 0 01-1.06-1.06l1.06-1.06a.75.75 0 011.06 0zM7.485 11.485a.75.75 0 010 1.06l-1.06 1.06a.75.75 0 01-1.06-1.06l1.06-1.06a.75.75 0 011.06 0zM14.696 14.696a.75.75 0 01-1.06 0l-1.06-1.06a.75.75 0 111.06-1.06l1.06 1.06a.75.75 0 010 1.06zM7.485 7.485a.75.75 0 01-1.06 0l-1.06-1.06a.75.75 0 111.06-1.06l1.06 1.06a.75.75 0 010 1.06zM15 10a.75.75 0 01-.75.75h-1.5a.75.75 0 010-1.5h1.5A.75.75 0 0115 10zM6.5 10a.75.75 0 01-.75.75h-1.5a.75.75 0 010-1.5h1.5A.75.75 0 016.5 10zM10 7a3 3 0 100 6 3 3 0 000-6z" clip-rule="evenodd" />
                                </svg> C├ílculo autom├ítico: <span x-text="largo"></span>m x <span x-text="ancho"></span>m = <span x-text="metros"></span>m┬▓
                            </p>
                        </div>
                    </div>
                    <div class="mb-6 bg-slate-50 p-5 rounded-xl border border-gray-200">
                        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-end mb-2 gap-2">
                            <label class="block text-sm font-medium">Descripci├│n <span class="text-red-500">*</span></label>
                            <span class="text-xs font-bold px-2 py-1 rounded-md" :class="{'bg-red-100 text-red-700': numPalabras < 20 || numPalabras > 120, 'bg-slate-100 text-[#003049]': numPalabras >= 20 && numPalabras <= 120}">
                                <span x-text="numPalabras"></span> / 120 palabras (M├¡n. 20)
                            </span>
                        </div>
                        <textarea name="descripcion" x-model="descripcion" @input="validarDescripcion($event.target)" rows="4" placeholder="Cu├®ntanos m├ís detalles del inmueble (M├¡nimo 20 palabras)..." required oninput="this.value = this.value.replace(/[^a-zA-Z0-9\s.,?!;:/\-├í├®├¡├│├║├ü├ë├ì├ô├Ü├▒├æ├╝├£\r\n]/g, '')" class="w-full rounded-lg border-input bg-white border py-3 px-4 focus:ring-[#003049]/20 focus:border-[#003049] transition-all" x-init="validarDescripcion($el)"></textarea>
                    </div>

                    {{-- NUEVO: Opciones Espec├¡ficas para Cuarto  --}}
                    <div class="mt-6 bg-slate-50 p-5 rounded-xl border border-gray-200" x-show="tipo === 'Cuarto'" style="display: none;">
                        <h3 class="font-bold text-[#003049] mb-3 text-sm">Configuraci├│n de Cuarto</h3>
                        
                        {{-- Zonas Comunes --}}
                        <div class="mb-4">
                            <label class="block text-sm font-medium mb-2">┬┐Tendr├í el inquilino acceso a zonas comunes?</label>
                            <div class="flex gap-4 mb-2">
                                <label class="flex items-center gap-2"><input type="radio" x-model="tieneZonasComunes" value="si" name="tiene_zonas_comunes"> S├¡</label>
                            ...
                            <div x-show="tieneZonasComunes === 'si'" class="grid grid-cols-2 gap-2 mt-2 bg-white p-3 rounded-lg border">
                                ...
                                <label class="flex items-center gap-2"><input type="checkbox" name="zonas_comunes[]" value="jardin"> Jard├¡n</label>
                ...
                <div x-show="step === 3" x-ref="step3" x-transition style="display: none;">
                    <h2 class="text-xl font-bold mb-4 flex items-center gap-2 text-primary">Reglas y Configuraci├│n de Pagos</h2>
                    ...
                    <div class="mb-6 bg-slate-50 p-5 rounded-xl border border-border">
                        <label class="block text-sm font-medium mb-3">┬┐Estar├ín permitidas las mascotas?</label>
                        <div class="flex gap-4 mb-3">
                            <label class="flex items-center gap-2 cursor-pointer">
                        ...
                        <div x-show="permiteMascotas === 'si'" x-transition class="mt-4 pt-4 border-t border-gray-200">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                                @php
                                    $listaMascotas = [
                                        'Perros', 'Gatos', 'Pericos y loros', 'P├íjaros de canto', 'Peces',
                                        'Hamsters y ratones', 'Conejos', 'Tortugas', 'Iguanas y lagartijas',
                                        'Serpientes', 'Ranas y ajolotes', 'Hurones', 'Ara├▒as y tar├íntulas',
                    ...
                    <div class="mb-6 bg-slate-50 p-5 rounded-xl border border-border">
                        <label class="block text-sm font-medium mb-3">┬┐Con qu├® servicios cuenta el inmueble?</label>
                    ...
                    {{-- Servicios (Matriz din├ímica) --}}
                    <div class="mb-6 border rounded-xl overflow-hidden" x-show="serviciosSeleccionados.length > 0" x-transition style="display: none;">
                        <div class="bg-slate-100 p-3 border-b font-medium text-sm text-center">┬┐Qui├®n ser├í responsable de pagar los servicios?</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div>
                <label class="block text-sm font-medium mb-1 text-muted-foreground">Tolerancia (D├¡as) <span class="text-red-500">*</span></label>
            ...
            <div>
                <label class="block text-sm font-medium mb-1 text-muted-foreground">Preaviso Salida (D├¡as) <span class="text-red-500">*</span></label>
        ...
        <div class="mb-6 bg-slate-50 p-5 rounded-xl border border-gray-200">
            <div class="flex items-center gap-2 mb-3">
                ...
                <label class="text-sm font-bold text-slate-700">Duraci├│n del Contrato <span class="text-red-500">*</span></label>
            </div>
            <p class="text-xs text-slate-500 mb-3">Define cu├íntos meses durar├í el contrato. El sistema calcular├í autom├íticamente la fecha de vencimiento.</p>
            <div class="flex items-center gap-4">
                ...
                <div class="flex gap-2">
                    ...
                    <button type="button" onclick="setDuracion(12)" class="px-3 py-1.5 text-xs font-bold bg-white border border-gray-200 rounded-lg hover:border-primary hover:text-primary transition-colors">1 a├▒o</button>
                    <button type="button" onclick="setDuracion(24)" class="px-3 py-1.5 text-xs font-bold bg-white border border-gray-200 rounded-lg hover:border-primary hover:text-primary transition-colors">2 a├▒os</button>
                </div>
            </div>
        </div>

                    {{-- Cl├íusulas Adicionales  --}}
                    <div class="mb-6 bg-slate-50 p-5 rounded-xl border border-border">
                        <label class="block text-sm font-medium mb-1 text-slate-800">┬┐Quiere incluir alguna cl├íusula o informaci├│n adicional?</label>
                        <p class="text-xs text-slate-500 mb-4 italic">La mayor├¡a de las personas no necesitan incluir cl├íusulas adicionales.</p>
                        
                        <div class="flex gap-4 mb-4">
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="radio" x-model="incluirClausulas" value="si" class="text-primary focus:ring-primary h-4 w-4">
                                <span class="text-sm font-medium uppercase text-slate-700">S├¡</span>
                            </label>
                            <label class="flex items-center gap-2 cursor-pointer">
                        ...
                        <div x-show="incluirClausulas === 'si'" x-transition class="space-y-4 pt-2">
                            <template x-for="(clausula, index) in clausulas" :key="index">
                                <div class="bg-white p-5 rounded-lg border border-gray-200 shadow-sm relative group">
                                    <h4 class="font-bold text-sm text-[#003049] mb-2">Cl├íusula adicional <span x-show="clausulas.length > 1" x-text="index + 1"></span></h4>
                                    <label class="block text-sm font-medium text-slate-600 mb-2">Escriba la cl├íusula utilizando oraciones completas:</label>
                                    
                                    <textarea x-model="clausulas[index]" rows="2" placeholder="Ej. El inquilino tendr├í acceso a la alberca comunitaria todos los viernes de 5:00 pm a 8:00 pm." oninput="this.value = this.value.replace(/[^a-zA-Z0-9\s.,?!;:/\-├í├®├¡├│├║├ü├ë├ì├ô├Ü├▒├æ├╝├£\r\n]/g, '')" class="w-full rounded-lg border-input bg-white border-b-2 focus:border-b-primary focus:ring-0 transition-all border-x-0 border-t-0 bg-transparent text-sm resize-none"></textarea>
                                    
                                    {{-- Bot├│n para eliminar cl├íusula si hay m├ís de una --}}
                                    <button type="button" @click="clausulas.splice(index, 1)" x-show="clausulas.length > 1" class="absolute top-4 right-4 text-red-400 hover:text-red-600 p-1 opacity-0 group-hover:opacity-100 transition-opacity" title="Eliminar cl├íusula">
                            ...
                            <button type="button" @click="clausulas.push('')" class="flex items-center gap-1 text-[#003049] hover:text-[#003049]/90 font-bold text-sm bg-transparent border-none cursor-pointer mt-3">
                                ...
                                A├▒ada otra cl├íusula
                            </button>
                        </div>
                        
                        {{-- Input oculto que env├¡a todo al backend concatenado, para garantizar compatibilidad --}}
                ...
                <div x-show="step === 4" x-ref="step4" x-transition style="display: none;">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative group cursor-pointer hover:bg-slate-50 transition-colors rounded-xl border-2 border-dashed border-gray-300 p-8 flex flex-col items-center justify-center text-center">
                            ...
                            <p class="text-sm font-medium text-foreground">Haz clic o arrastra m├ís fotos</p>
                        </div>
                    </div>
                ...
                <div class="pt-6 border-t border-border flex justify-between items-center mt-6">
                    <button type="button" @click="step--" x-show="step > 1" class="text-muted-foreground hover:text-foreground font-medium px-4 py-2 transition-colors">ÔåÉ Atr├ís</button>
                    ...
                    <button type="button" @click="nextStep()" x-show="step < 4" class="bg-primary text-primary-foreground font-bold py-2 px-6 rounded-xl hover:bg-primary/90 transition-all shadow-md shadow-primary/20">Siguiente Paso ÔåÆ</button>
    ...
    <script>
        ...
        async function buscarDireccion() {
            ...
            try {
                ...
                if (data && data.length > 0) {
                    ...
                    actualizarPin(lat, lon, 17); // Zoom m├ís cercano al encontrar direcci├│n
                } else {
                    alert("No pudimos encontrar esa calle exacta. ┬┐Podr├¡as marcar el punto manualmente en el mapa?");
                }
            } catch (error) {
        ...
        async function obtenerDireccionDesdeMapa(lat, lng) {
            ...
            inputDireccion.value = "Buscando direcci├│n exacta...";
        ...
        function geolocalizar() {
            ...
            navigator.geolocation.getCurrentPosition(
                ...
                (error) => {
                    ...
                    if(error.code === 1) msg = "Por favor, permite el acceso a tu ubicaci├│n en el navegador.";
                    alert(msg);
                    btn.innerHTML = originalContent;
                    btn.disabled = false;
                },
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('wizardForm', () => ({
                ...
                validarDescripcion(el) {
                    ...
                    if (count < 20) {
                        el.setCustomValidity("La descripci├│n debe tener al menos 20 palabras.");
                    } else if (count > 120) {
                        el.setCustomValidity("La descripci├│n no puede exceder las 120 palabras.");
                    } else {
                ...
                validarFotos(e) {
                    if (this.files.length < 5) {
                        ...
                        Swal.fire({
                            icon: 'warning',
                            title: 'Faltan fotos',
                            text: 'El inmueble debe de tener al menos 5 fotograf├¡as para poder publicarse.',
                            confirmButtonColor: '#003049'
                        });
                        return false;
                    }
                ...
                nextStep() {
                    ...
                    for (let input of inputs) {
                        if (!input.checkValidity()) {
                            // Validaciones que est├ín ocultas no prevendr├ín navegaci├│n
                            if(input.offsetWidth > 0 || input.offsetHeight > 0) {
                                console.error("Validaci├│n fallida en campo:", input.name);
