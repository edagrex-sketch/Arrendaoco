        ...
        <div class="w-full max-w-5xl flex flex-col lg:flex-row bg-white rounded-3xl shadow-2xl overflow-hidden min-h-[600px]">
            ...
            <div class="w-full lg:w-1/2 h-48 lg:h-auto overflow-hidden relative">
                ...
                <div class="absolute inset-0 bg-gradient-to-t lg:bg-gradient-to-r from-[#003049]/80 via-[#003049]/40 to-transparent flex flex-col items-center justify-center z-10 p-6 lg:p-12 text-center lg:text-left">
                    <h2 class="text-2xl lg:text-4xl font-bold text-white mb-2 lg:mb-4 drop-shadow-lg">
                        Más que una casa, encuentra tu hogar
                    </h2>
                    <p class="text-white/80 text-sm lg:text-lg font-medium drop-shadow-md max-w-xs">
            ...
            <div class="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12">
                <div class="w-full max-w-md">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-5">
                        ...
                        @error('email')
                            <div
                                class="bg-red-50 border-l-4 border-red-500 text-red-700 p-3 text-sm rounded-r shadow-sm">
                                {{ $message }}
                            </div>
                        @enderror
                        ...
                        <!-- Botón -->
                        <button
                            class="w-full bg-[#003049] hover:bg-[#002538] text-white py-3.5 rounded-lg font-bold shadow-md transform transition-all duration-200">
                            Iniciar sesión
                        </button>
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <a href="{{ route('social.login', 'google') }}"
                                class="flex items-center justify-center gap-3 px-4 py-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-all duration-200 font-semibold text-gray-700 shadow-sm">
