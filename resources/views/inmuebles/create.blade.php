                ...
                <div x-show="step === 2" x-ref="step2" x-transition style="display: none;">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex gap-2">
                            ...
                            <button type="button" onclick="buscarDireccion()" class="bg-primary hover:bg-primary/90 text-white px-4 py-2 rounded-lg transition-all text-sm font-bold flex items-center gap-2">
