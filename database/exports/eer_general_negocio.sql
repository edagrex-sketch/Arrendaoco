-- EER General de Negocio
-- Generado desde bd_arrendaoco el 2026-03-16
DROP DATABASE IF EXISTS `eer_general_negocio`;
CREATE DATABASE `eer_general_negocio` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `eer_general_negocio`;
...
-- Dump completed on 2026-03-16 23:01:26
