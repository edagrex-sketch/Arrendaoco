...
class InmueblesVeridicosSeeder extends Seeder
{
    public function run()
    {
        ...
        $inmuebles = [
            ...
            [
                'titulo' => 'Local Comercial en Plaza Central',
                'direccion' => 'Portal de la Independencia #3, Centro Histórico',
                'ciudad' => 'Ocosingo',
                'estado' => 'Chiapas',
                'codigo_postal' => '29950',
                'descripcion' => 'Local comercial con alto flujo peatonal, cortina de acero, medio baño y bodega pequeña. Excelente para boutique o servicios profesionales.',
                'renta_mensual' => 12000,
                'deposito' => 12000,
                'habitaciones' => 0,
                'banos' => 1,
                'metros' => 60,
                'tipo' => 'Local',
                'imagen' => '/storage/inmuebles/local_centro.png',
                'propietario_id' => $adminId,
                'estatus' => 'disponible',
            ],
            [
