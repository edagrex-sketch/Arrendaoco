...
class InmuebleResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'servicios_incluidos' => is_array($this->servicios_incluidos) ? $this->servicios_incluidos : ($this->servicios->pluck('servicio')->toArray() ?? []),
            'pago_servicio' => $this->mergeServiciosParaApp(),
